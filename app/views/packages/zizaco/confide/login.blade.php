      ...
      <div class="col-md-6">
        ...
        <form method="POST" action="{{{ URL::to('users') }}}" accept-charset="UTF-8">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <input class="form-control" placeholder="E-Mail" type="text" name="email" id="email" value="{{{ Input::old('email') }}}">
                </div>
                <div class="form-group">
                    <input class="form-control" type="text" name="document_id" placeholder="Nro. de Documento de Identidad">
                </div>
                <div class="form-group">
